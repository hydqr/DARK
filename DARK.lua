...
JSON = dofile("./DaRk_lib/dkjson.lua")
json = dofile("./DaRk_lib/JSON.lua")
URL = dofile("./DaRk_lib/url.lua")
serpent = dofile("./DaRk_lib/serpent.lua")
database = dofile("./DaRk_lib/redis.lua").connect("127.0.0.1", 6379)
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hydqr/Files_DARK/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/hydqr/DaRk2/master/DARK.lua')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DARKcrl')..') \n ✸∫ تـم قفـل الدردشه ')
end,nil)   
